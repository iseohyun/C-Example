...
#include "framework.h"
#include "12_Buffer_Bubble_bitmap.h"
#include <stdlib.h>
#include <time.h>
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY12BUFFERBUBBLEBITMAP, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY12BUFFERBUBBLEBITMAP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_MY12BUFFERBUBBLEBITMAP));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_MY12BUFFERBUBBLEBITMAP);
